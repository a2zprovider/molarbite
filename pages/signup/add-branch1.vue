        ...
        <form class="space-y-6 w-full" @submit.prevent>
          <div>
            ...
            <div class="mt-2 inline-flex items-center justify-between w-full">
              <div
                class="inline-flex items-center justify-between w-full h-[32px] p-1.5 px-2 mr-3 text-[#0052cc] bg-[#0052CC] border border-[#0052cc] rounded bg-[#0052cc] border-[#0052cc] text-white"
              >
              ...
              <div
                class="inline-flex justify-start items-center h-[32px] rounded border-[1px] border-[#0052CC] p-1.5 px-2"
              >
                <Icon
                  name="mdi:pencil"
                  size="14"
          ...
          <hr class="border-[#BDBDBD]" />
          <div
            class="mt-2 inline-flex items-center justify-between w-full h-[32px] p-1.5 px-2 text-[#0052cc] bg-white border border-[#0052cc] rounded cursor-pointer peer-checked:bg-[#01875A] peer-checked:border-[#01875A] peer-checked:text-white"
          >
